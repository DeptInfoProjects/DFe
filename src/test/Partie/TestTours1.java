...
public class TestTours1 extends TestTours2 {
    ...
    public void test0() {
        ...
        doReturn(Ressource.OR).when(face1).getRes();
        doReturn(6).when(face1).getValeur();
        ...
        doReturn(Ressource.VICTOIRE).when(face2).getRes();
        doReturn(8).when(face2).getValeur();
        Face face3 = mock(Face.class, new ViolatedAssumptionAnswer());
        doReturn(Ressource.OR).when(face3).getRes();
        doReturn(7).when(face3).getValeur();
        ...
        doReturn(de0, de2, new De()).when(joueur0).getD1();
